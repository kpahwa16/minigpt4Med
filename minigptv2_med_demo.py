...
vis_processor_cfg = cfg.datasets_cfg.pmc_caption.vis_processor.train
...
title = """<h1 align="center">MiniGPT-v2 Medical Demo</h1>"""
description = 'Welcome to Our MiniGPT-v2 Medical Chatbot Demo!'
